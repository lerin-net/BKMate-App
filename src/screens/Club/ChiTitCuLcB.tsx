...
import { StyleSheet, Text, View, Linking, Pressable, ImageStyle } from 'react-native';
...
const ChiTitCuLcB = () => {
  ...
  // Call REST GET API from server localhost:3001/clubs
  const domain = process.env.API_URL;
  const resourse = 'clubs';
  const url = `${domain}/${resourse}`;
    ...
    <View style={styles.chiTitCuLcB1}>
      <View style={styles.statusBar}>
        <View style={styles.statusBar1}>
          <Image
            style={[styles.uiIcon, styles.uiIconPosition] as ImageStyle}
            contentFit="cover"
      ...
      <View style={styles.content}>
        <View style={styles.chiTit}>
          <View style={[styles.nhCuLcB2, styles.nhCuLcB2Position]}>
            <View style={[styles.nh2, styles.nh2Layout]}>
              <Image
                style={[styles.image16Icon, styles.nhCuLcB2Position] as ImageStyle}
                contentFit="cover"
          ...
          <View style={[styles.thngTinChiTit1, styles.nhCuLcB2Layout]}>
            <Text style={[styles.nViCeacContainer, styles.time1Clr]}>
              {data[0]?.description}
              <Text
                style={styles.bitlyceacTuyenquan2023Form}
        ...
        <View style={[styles.cuLcB2, styles.uiIconPosition]}>
          <Text style={styles.cuLcB3}>{data[0]?.name}</Text>
          <View style={[styles.nhCuLcB3, styles.nhCuLcB3Position]}>
            <Image
              style={[styles.image15Icon, styles.nhCuLcB3Position] as ImageStyle}
              contentFit="cover"
      ...
      >
        <Image
          style={styles.backChild as ImageStyle}
          contentFit="cover"
